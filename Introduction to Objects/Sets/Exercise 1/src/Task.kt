...
fun percentMeat(groceryCart: Set<String>): Double = getPercentage(meats, groceryCart)
fun percentFruit(groceryCart: Set<String>): Double = getPercentage(fruits, groceryCart)
fun percentVeggies(groceryCart: Set<String>): Double = getPercentage(vegetables, groceryCart)
fun percentOther(groceryCart: Set<String>): Double = 100.0 * (groceryCart - meats - fruits - vegetables).size / groceryCart.size
