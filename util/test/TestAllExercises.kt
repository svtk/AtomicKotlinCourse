...
class TestAllExercises : AbstractTestExercises() {
  ...
  @Test
  fun `test#217 ClassDelegation Exercise#1`() = testClass(classDelegationExercise1.TestClassDelegationExercise1::class)

  @Test
  fun `test#218 ClassDelegation Exercise#2`() = testClass(classDelegationExercise2.TestClassDelegationExercise2::class)

  @Test
  fun `test#219 ClassDelegation Exercise#3`() = testClass(classDelegationExercise3.TestClassDelegationExercise3::class)

  @Test
  fun `test#220 Downcasting Exercise#1`() = testClass(downcastingExercise1.TestDowncastingExercise1::class)

  @Test
  fun `test#221 Downcasting Exercise#2`() = testClass(downcastingExercise2.TestDowncastingExercise2::class)

  @Test
  fun `test#222 Downcasting Exercise#3`() = testClass(downcastingExercise3.TestDowncastingExercise3::class)

  @Test
  fun `test#223 SealedClasses Exercise#1`() = testClass(sealedClassesExercise1.TestSealedClassesExercise1::class)

  @Test
  fun `test#224 SealedClasses Exercise#2`() = testClass(sealedClassesExercise2.TestSealedClassesExercise2::class)

  @Test
  fun `test#225 SealedClasses Exercise#3`() = testClass(sealedClassesExercise3.TestSealedClassesExercise3::class)

  @Test
  fun `test#226 TypeChecking Exercise#1`() = testClass(typeCheckingExercise1.TestTypeCheckingExercise1::class)

  @Test
  fun `test#227 TypeChecking Exercise#2`() = testClass(typeCheckingExercise2.TestTypeCheckingExercise2::class)

  @Test
  fun `test#228 TypeChecking Exercise#3`() = testClass(typeCheckingExercise3.TestTypeCheckingExercise3::class)

  @Test
  fun `test#229 NestedClasses Exercise#1`() = testClass(nestedClassesExercise1.TestNestedClassesExercise1::class)

  @Test
  fun `test#230 NestedClasses Exercise#2`() = testClass(nestedClassesExercise2.TestNestedClassesExercise2::class)

  @Test
  fun `test#231 NestedClasses Exercise#3`() = testClass(nestedClassesExercise3.TestNestedClassesExercise3::class)

  @Test
  fun `test#232 NestedClasses Exercise#4`() = testClass(nestedClassesExercise4.TestNestedClassesExercise4::class)
  ...
  @Test
  fun `test#236 Objects Exercise#1`() = testClass(objectsExercise1.TestObjectsExercise1::class)

  @Test
  fun `test#237 Objects Exercise#2`() = testClass(objectsExercise2.TestObjectsExercise2::class)

  @Test
  fun `test#238 Objects Exercise#3`() = testClass(objectsExercise3.TestObjectsExercise3::class)

  @Test
  fun `test#239 CompanionObjects Exercise#1`() = testClass(companionObjectsExercise1.TestCompanionObjectsExercise1::class)

  @Test
  fun `test#240 CompanionObjects Exercise#2`() = testClass(companionObjectsExercise2.TestCompanionObjectsExercise2::class)

  @Test
  fun `test#241 CompanionObjects Exercise#3`() = testClass(companionObjectsExercise3.TestCompanionObjectsExercise3::class)

  @Test
  fun `test#242 ObjectOrientedDesign Exercise#1`() = testClass(objectOrientedDesignExercise1.TestObjectOrientedDesignExercise1::class)

  @Test
  fun `test#243 ObjectOrientedDesign Exercise#2`() = testClass(objectOrientedDesignExercise2.TestObjectOrientedDesignExercise2::class)

  @Test
  fun `test#244 ObjectOrientedDesign Exercise#3`() = testClass(objectOrientedDesignExercise3.TestObjectOrientedDesignExercise3::class)

  @Test
  fun `test#245 LambdaWithReceiver Exercise#1`() = testClass(lambdaWithReceiverExercise1.TestLambdaWithReceiverExercise1::class)

  @Test
  fun `test#246 LambdaWithReceiver Exercise#2`() = testClass(lambdaWithReceiverExercise2.TestLambdaWithReceiverExercise2::class)

  @Test
  fun `test#247 TheWithFunction Exercise#1`() = testClass(theWithFunctionExercise1.TestTheWithFunctionExercise1::class)

  @Test
  fun `test#248 TheWithFunction Exercise#2`() = testClass(theWithFunctionExercise2.TestTheWithFunctionExercise2::class)

  @Test
  fun `test#249 ScopeFunctions Exercise#1`() = testClass(scopeFunctionsExercise1.TestScopeFunctionsExercise1::class)

  @Test
  fun `test#250 ScopeFunctions Exercise#2`() = testClass(scopeFunctionsExercise2.TestScopeFunctionsExercise2::class)

  @Test
  fun `test#251 ScopeFunctions Exercise#3`() = testClass(scopeFunctionsExercise3.TestScopeFunctionsExercise3::class)

  @Test
  fun `test#252 Hashing Exercise#1`() = testClass(hashingExercise1.TestHashingExercise1::class)
}