...
class TestAllExercises : AbstractTestExercises() {
  ...
  @Test
  fun `test#207 Composition Exercise#1`() = testClass(compositionExercise1.TestCompositionExercise1::class)

  @Test
  fun `test#208 Composition Exercise#2`() = testClass(compositionExercise2.TestCompositionExercise2::class)

  @Test
  fun `test#209 Composition Exercise#3`() = testClass(compositionExercise3.TestCompositionExercise3::class)

  @Test
  fun `test#210 InheritanceAndExtensions Exercise#1`() = testClass(inheritanceAndExtensionsExercise1.TestInheritanceAndExtensionsExercise1::class)

  @Test
  fun `test#211 InheritanceAndExtensions Exercise#2`() = testClass(inheritanceAndExtensionsExercise2.TestInheritanceAndExtensionsExercise2::class)

  @Test
  fun `test#212 InheritanceAndExtensions Exercise#3`() = testClass(inheritanceAndExtensionsExercise3.TestInheritanceAndExtensionsExercise3::class)
  ...
  @Test
  fun `test#222 NestedClasses Exercise#1`() = testClass(nestedClassesExercise1.TestNestedClassesExercise1::class)

  @Test
  fun `test#223 NestedClasses Exercise#2`() = testClass(nestedClassesExercise2.TestNestedClassesExercise2::class)

  @Test
  fun `test#224 NestedClasses Exercise#3`() = testClass(nestedClassesExercise3.TestNestedClassesExercise3::class)

  @Test
  fun `test#225 NestedClasses Exercise#4`() = testClass(nestedClassesExercise4.TestNestedClassesExercise4::class)

  @Test
  fun `test#226 InnerClasses Exercise#1`() = testClass(innerClassesExercise1.TestInnerClassesExercise1::class)

  @Test
  fun `test#227 InnerClasses Exercise#2`() = testClass(innerClassesExercise2.TestInnerClassesExercise2::class)

  @Test
  fun `test#228 InnerClasses Exercise#3`() = testClass(innerClassesExercise3.TestInnerClassesExercise3::class)
  ...
  @Test
  fun `test#232 CompanionObjects Exercise#1`() = testClass(companionObjectsExercise1.TestCompanionObjectsExercise1::class)

  @Test
  fun `test#233 CompanionObjects Exercise#2`() = testClass(companionObjectsExercise2.TestCompanionObjectsExercise2::class)

  @Test
  fun `test#234 CompanionObjects Exercise#3`() = testClass(companionObjectsExercise3.TestCompanionObjectsExercise3::class)

  @Test
  fun `test#235 ObjectOrientedDesign Exercise#1`() = testClass(objectOrientedDesignExercise1.TestObjectOrientedDesignExercise1::class)

  @Test
  fun `test#236 ObjectOrientedDesign Exercise#2`() = testClass(objectOrientedDesignExercise2.TestObjectOrientedDesignExercise2::class)

  @Test
  fun `test#237 ObjectOrientedDesign Exercise#3`() = testClass(objectOrientedDesignExercise3.TestObjectOrientedDesignExercise3::class)

  @Test
  fun `test#238 LambdaWithReceiver Exercise#1`() = testClass(lambdaWithReceiverExercise1.TestLambdaWithReceiverExercise1::class)

  @Test
  fun `test#239 LambdaWithReceiver Exercise#2`() = testClass(lambdaWithReceiverExercise2.TestLambdaWithReceiverExercise2::class)

  @Test
  fun `test#240 TheWithFunction Exercise#1`() = testClass(theWithFunctionExercise1.TestTheWithFunctionExercise1::class)

  @Test
  fun `test#241 TheWithFunction Exercise#2`() = testClass(theWithFunctionExercise2.TestTheWithFunctionExercise2::class)

  @Test
  fun `test#242 ScopeFunctions Exercise#1`() = testClass(scopeFunctionsExercise1.TestScopeFunctionsExercise1::class)

  @Test
  fun `test#243 ScopeFunctions Exercise#2`() = testClass(scopeFunctionsExercise2.TestScopeFunctionsExercise2::class)

  @Test
  fun `test#244 ScopeFunctions Exercise#3`() = testClass(scopeFunctionsExercise3.TestScopeFunctionsExercise3::class)

  @Test
  fun `test#245 Hashing Exercise#1`() = testClass(hashingExercise1.TestHashingExercise1::class)
}